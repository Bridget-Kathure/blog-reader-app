...
import com.akirachix.blog_reader_app.R


class BlogAdapter(val article:List<Article>):RecyclerView.Adapter<ArticleViewHolder>(){
...
class  ArticleViewHolder(itemView:View):RecyclerView.ViewHolder(itemView){
    ...
    val tvTittle=itemView.findViewById<TextView>(R.id.tvTitle)
